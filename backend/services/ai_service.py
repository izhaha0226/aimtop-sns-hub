...
async def generate_operation_plan(
    ...
    prompt = (
        ...
        "0) Own-brand study: 경쟁사보다 먼저 우리 브랜드의 이번 달 대표 홍보 오퍼(primary_offer)를 확정한다. product_summary/notes에 VIP·멤버십·프로그램·강의·패키지 같은 구체 오퍼가 있으면 반드시 primary_offer와 주차별 계획에 반영한다.\n"
        ...
        "반드시 brand_study 배열에 우리 브랜드/대표 오퍼 판단을 먼저 요약하고, primary_offer를 명시해라. "
